    ...
    <div class="bg-secondary-custom question-window rcorners">
      <div id="questions" class="center-screen">
        <div>
          ...
          <div
            v-for="item in this.currentQuestion.equations"
            :key="item"
            v-katex:auto="{ colorIsTextColor: false }"
            class="katex"
          >
            {{ item }}
          </div>
      ...
      <div id="options" class="list-group">
        <div class="form-check content-checkbox">
          <label
            v-for="(item, index) in this.currentQuestion.options"
            :key="index"
            :ref="'radio-' + index"
            class="content-checkbox"
            @change="inputAnswer(index)"
          >
            <input name="radiogroup" type="radio" v-model="selected[index]" />
