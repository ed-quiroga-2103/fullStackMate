<template>
    <div class="bg-dark-custom mainbody center-screen">
        <form
            ...
            class="contain px-5 bg-contrast-custom font-light-custom rcorners"
        >
            <div>
                <h3 class="form-label font-light-custom">Registration</h3>
            </div>
            <div class="mb-3">
                <label for="InputEmail1" class="form-label font-light-custom"
                    >Email address</label
                >
                <input
                    type="email"
            ...
            <div class="mb-3">
                <label for="InputName" class="form-label font-light-custom"
                    >First Name</label
                >
                <input type="text" class="form-control" id="InputName" />
            </div>
            <div class="mb-3">
                <label for="InputLastName" class="form-label font-light-custom"
                    >Last Name</label
                >
                <input type="text" class="form-control" id="InputLastName" />
            </div>
            <div class="mb-3">
                <label for="InputPassword1" class="form-label font-light-custom"
                    >Password</label
                >
                <input
                    type="password"
            ...
            <div class="mb-3 no-arrows">
                <label
                    for="InputID"
                    class="form-label font-light-custom no-arrows"
                    >ID</label
                >
                <input
                    type="number"
